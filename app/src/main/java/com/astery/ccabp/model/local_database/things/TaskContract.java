...
public class TaskContract {
    public static final class TaskEntry  extends Entry implements BaseColumns{

        public static final String TABLE_NAME = "task_table";

        public static final String COLUMN_CHILD_ID = "childId";
        // день цифрой с определенного момента
        ...
        /** типы: 1 - напрямую из плана, 2 - измененный из заявки, 3 - не сохраненный*/
